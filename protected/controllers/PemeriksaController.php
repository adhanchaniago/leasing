...
class PemeriksaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				...
				'expression'=>array('PemeriksaController','allowOnlyOwner'),
			),
	...
	{
		$model = Pemeriksa::model()->findByPk($id);
	...
	{
		$dataProvider=new CActiveDataProvider('Pemeriksa');
	...
	{
		$model=new Pemeriksa('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['Pemeriksa'])) {
			$model->attributes=$_GET['Pemeriksa'];
		}
	 ...
	 * @return Pemeriksa the loaded model
	 ...
	 * @param Pemeriksa $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='pemeriksa-form') {
