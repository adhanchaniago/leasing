...
<div class="form">
	...
	<div class="row">
		<div class="col-lg-4">
			<?php echo $form->textFieldControlGroup($model,'username',array('span'=>5,'maxlength'=>45,'readonly'=>$model->isNewRecord ? false:true)); ?>
			...
			<?php echo $form->emailFieldControlGroup($model,'email',array('span'=>5,'maxlength'=>45)); ?>

			<?php echo $form->textFieldControlGroup($model,'telepon',array('span'=>5,'maxlength'=>45)); ?>

			<?php echo $form->textFieldControlGroup($model,'penghasilan',array('span'=>5,'maxlength'=>45)); ?>
		</div>
	</div>
